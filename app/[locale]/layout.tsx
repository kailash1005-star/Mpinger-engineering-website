  ...
  return (
    <NextIntlClientProvider messages={messages}>
      ...
      {/* Renders the consent banner and, only once consent is given, the
          Microsoft Clarity and GA tags. Mounted inside the provider so its
          statutory text can be translated; last in the tree so it never
          delays the page it measures. */}
      <CookieConsent />
